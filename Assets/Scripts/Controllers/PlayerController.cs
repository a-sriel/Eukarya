...
public class PlayerController : MonoBehaviour
{
    ...
    // Stamina Reference
    [SerializeField] private StaminaBarManager staminaScript;
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.LeftShift) || Input.GetKeyDown(KeyCode.RightShift) && staminaScript.CanSprint())
        {
